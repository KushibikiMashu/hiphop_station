...
class VideoRepositoryTest extends TestCase
{
     ...
     * @test
     */
    public function getAllVideoJoinedChannel__この２週間のchannelとvideoテーブルをjoinしたレコードを取得する(): void
    {
        $channel = self::createChannelRecord();
        $video = self::createVideoRecord();
        $actual = $this->instance->getAllVideoJoinedChannel();
        ...
        $this->assertArrayHasKey('publishedAt', $first);
        $this->assertArrayHasKey('createdAt', $first);
        $this->assertArrayHasKey('channelId', $first);
        $this->assertArrayHasKey('channelTitle', $first);
        $this->assertArrayHasKey('channelHash', $first);
        $this->assertArrayHasKey('channelPublishedAt', $first);
        $this->assertArrayHasKey('channelCreatedAt', $first);
